...
{
    color: <?php echo $wyde_color_scheme; ?>;
}
.view .post.sticky,
...
.heading.title-10 h2:after {
    border-top-color: <?php echo $wyde_color_scheme; ?>;
}
::-moz-selection{
    background: <?php echo $wyde_color_scheme; ?>;
}
::selection {
    background: <?php echo $wyde_color_scheme; ?>;
}
...
.heading.title-9 h2:before{
    border-color: <?php echo $wyde_color_scheme; ?>;
}
.link-button span,
#toTop .border:before,
...
.effect-bubba figure{
    background-color: <?php echo $wyde_color_scheme; ?>;
}
.pagination a:hover,
