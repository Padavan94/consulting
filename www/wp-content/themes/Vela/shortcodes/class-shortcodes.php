        ...
        vc_map( array(
	        ...
	        'params' => array(
                array(
                    ...
                    'description' => __('Invert text color for this section, apply white color in "Light" skin and black color in "Dark" skin.', 'Vela')
                ),
                array(
                    'type' => 'checkbox',
                    'class' => '',
                    ...
                    'description' => __('Apply darken background color.', 'Vela')
                ),
                array(
                    'type' => 'checkbox',
                    'class' => '',
                    ...
                    'description' => __('Enable parallax background scrolling.', 'Vela')
                ),
                array(
                    'type' => 'checkbox',
                    'class' => '',
                    ...
                    'description' => __('Full width section.', 'Vela')
                ),
                array(
                    'type' => 'checkbox',
                    'class' => '',
                    ...
                    'description' => __('Full screen section (Full height).', 'Vela')
                ),
                array(
                    'type' => 'dropdown',
                    'class' => '',
        ...
        vc_map( array(
	        ...
	        'params' => array(
		        ...
		        array(
			        ...
			        'param_name' => 'el_id',
			        'description' => sprintf( __( 'Enter optionally row ID. Make sure it is unique, and it is valid as w3c specification: %s (Must not have spaces)', 'Vela' ), '<a target="_blank" href="http://www.w3schools.com/tags/att_global_id.asp">' . __( 'link', 'Vela' ) . '</a>' ),
		        ),
                array(
                      'type' => 'textfield',
                      'class' => '',
