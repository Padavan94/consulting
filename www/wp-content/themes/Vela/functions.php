...
function vela_load_styles(){
    ...
    wp_enqueue_style('vela-owl', $asset_base_uri . '/css/owl.carousel.css', null, null);

    wp_enqueue_style('vela-theme', $asset_base_uri . '/css/vela'.$min.'.css', null, '1.5.5');
...
function vela_load_scripts(){
    ...
    wp_register_script('wyde-page', $asset_base_uri . '/js/page'.$min.'.js', null, '1.5.5', true);
    ...
    if($wyde_options['ajax_page']){
        ...
        wp_register_script('ajax-page', $asset_base_uri . '/js/ajax-page'.$min.'.js', null, '1.5.5', true);
    ...
    if($wyde_options['ajax_search']){
        ...
        wp_register_script('ajax-search', $asset_base_uri . '/js/ajax-search'.$min.'.js', null, '1.5.5', true);
