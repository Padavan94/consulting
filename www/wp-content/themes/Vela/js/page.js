                    ...
                    $(".rev_slider").each(function () {
                        ...
                        if (api) {
                            ...
                            try {
                                ...
                                var gridWidth = 0,
                                    zoomSelector = '.mobile-zoom, .heading, p, a, .button, .link-button, .ghost-button',
                                ...
                                var items = slider.find(zoomSelector).each(function () {
                                    var $el = $(this);

                                    var posY = $el.parents(".tp-caption").data("voffset");

                                    if (posY == 0) {
                                        scaleFrom = "center center";
                                    } else if (posY > 0) {
                                        scaleFrom = "center -100%";
                                    } else if (posY < 0) {
                                        scaleFrom = "center 100%";
                                    }


                                    $el.css({ transformOrigin: scaleFrom });
                                });
