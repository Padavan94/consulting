...
if (!class_exists('Wyde_Theme_Options')) {

    class Wyde_Theme_Options {
        ...
        public function setSections() {
            ...
            $import_fields = array(
                    array(
                        'id'        => 'section_import',
                        'type'      => 'section',
                        'title'     => __('Import Settings', 'Vela'),
                        'subtitle'  => __('Importing settings will give you the site settings including the Theme Options settings, Widgets settings, Menu Location settings and also Front page settings. This option suited for the site which has an existing content that created with Visual Composer and also compatible with the Vela theme.', 'Vela'),
                        'indent'    => true
                    ),
                    array(
                        'id'        => 'notice-warning',
                        ...
                        'desc'      => __('Importing settings will replace your current settings. It can also take a minute to complete.', 'Vela')
                    ),
                    array(
                        'id'        => 'raw_import',
                        'type'      => 'raw',
                        'content'   => '<div class="import-wrapper"><div class="demo-list"><a id="demo-1" href="'.admin_url('themes.php?page=theme-options') . '&demo=1&import_data=settings'.'" class="demo-item"><img src="'. $template_directory .'/admin/importer/images/vela1.jpg" alt="Demo 1"/></a><a id="demo-2" href="'.admin_url('themes.php?page=theme-options') . '&demo=2&import_data=settings'.'" class="demo-item"><img src="'. $template_directory .'/admin/importer/images/vela2.jpg" alt="Demo 2"/></a><a id="demo-3" href="'.admin_url('themes.php?page=theme-options') . '&demo=3&import_data=settings'.'" class="demo-item"><img src="'. $template_directory .'/admin/importer/images/vela3.jpg" alt="Demo 3"/></a><a id="demo-4" href="'.admin_url('themes.php?page=theme-options') . '&demo=4&import_data=settings'.'" class="demo-item"><img src="'. $template_directory .'/admin/importer/images/vela4.jpg" alt="Demo 4"/></a><a id="demo-5" href="'.admin_url('themes.php?page=theme-options') . '&demo=5&import_data=settings'.'" class="demo-item"><img src="'. $template_directory .'/admin/importer/images/vela5.jpg" alt="Demo 5"/></a></div></div>', // all demos
                    ),                    
                    array(
                        'id'        => 'section_import',
                        'type'      => 'section',
                        'title'     => __('Import Demo Content', 'Vela'),
                        'subtitle'  => __('Importing demo content will give you pages, posts, portfolio, team members, testimonials, widgets, sidebars, sliders and other settings. Please make sure you have required plugins installed and activated to receive that portion of the content. This option suited for the site which hasn\'t any existing content or the demo site.', 'Vela'),
                        'indent'    => true
                    ),
                    array(
                        'id'        => 'notice-warning',
                        ...
                        'icon'      => 'el el-warning-sign',
                        'title'     => __('WARNING:', 'Vela'),
                        'desc'      => __('Importing demo content will replace your current settings and append your pages and posts. It can also take a minute to complete. <br />If you want to remove all existing data before importing, Please try <a href="https://wordpress.org/plugins/wordpress-reset/" target="_blank">WordPress Reset</a> plugin to reset your existing data.', 'Vela')
                    ),
                    array(
                        'id'        => 'raw_import',
                        'type'      => 'raw',
                        //'content'   => '<div class="import-wrapper"><div class="demo-list"><a id="demo-5" href="'.admin_url('themes.php?page=theme-options') . '&demo=5&import_data=democontent'.'" class="demo-item"><img src="'. $template_directory .'/admin/importer/images/vela5.jpg" alt="Demo 5"/></a></div></div>', // latest demo
                        'content'   => '<div class="import-wrapper"><div class="demo-list"><a id="demo-1" href="'.admin_url('themes.php?page=theme-options') . '&demo=1&import_data=democontent'.'" class="demo-item"><img src="'. $template_directory .'/admin/importer/images/vela1.jpg" alt="Demo 1"/></a><a id="demo-2" href="'.admin_url('themes.php?page=theme-options') . '&demo=2&import_data=democontent'.'" class="demo-item"><img src="'. $template_directory .'/admin/importer/images/vela2.jpg" alt="Demo 2"/></a><a id="demo-3" href="'.admin_url('themes.php?page=theme-options') . '&demo=3&import_data=democontent'.'" class="demo-item"><img src="'. $template_directory .'/admin/importer/images/vela3.jpg" alt="Demo 3"/></a><a id="demo-4" href="'.admin_url('themes.php?page=theme-options') . '&demo=4&import_data=democontent'.'" class="demo-item"><img src="'. $template_directory .'/admin/importer/images/vela4.jpg" alt="Demo 4"/></a><a id="demo-5" href="'.admin_url('themes.php?page=theme-options') . '&demo=5&import_data=democontent'.'" class="demo-item"><img src="'. $template_directory .'/admin/importer/images/vela5.jpg" alt="Demo 5"/></a></div></div>', // all demos
                    )
            );
            ...
            if($imported == 'success' ){
                ...
                array_unshift($import_fields, array(
                        ...
                        'desc'      => __('The demo content has been successfully imported.', 'Vela')
                    ));
            ...
            $this->sections['page'] = array(
                ...
                'fields'    => array(
                    ...
                    array(
                        ...
                        'type'      => 'section',
                        'title'     => __('Page Options', 'Vela'),
                        'subtitle'  => __('Customize page options.', 'Vela'),
                        'indent'    => true
                    ),
                    array(
                        'id'        => 'onepage',
                    ...
                    array(
                        'id'        => 'mobile_animation',
                        'type'      => 'switch',
                        'title'     => __('Animation on Mobile', 'Vela'),
                        'subtitle'  => __('Turn on this option to enable animation on mobile.', 'Vela'),
                        'default'   => false,
                    ),
                    array(
                        'id'        => 'smooth_scroll',
                    ...
                    array(
                        'id'        => 'preload_images',
                        'type'      => 'switch',
                        'title'     => __('Preload Images', 'Vela'),
                        'subtitle'  => __('Preloading images definitely helps users enjoy a better experience when viewing your content.', 'Vela'),
                        'default'   => false,
                    ),
                    array(
                        'id'        => 'page_loader',
                        'type'      => 'image_select',
                        'title'     => __('Page Loader', 'Vela'),
                    ...
                    array(
                        ...
                        'type'      => 'section',
                        'title'     => __('AJAX Options', 'Vela'),
                        'subtitle'  => __('Turn on or off the AJAX page features.', 'Vela'),
                        'indent'    => true
                    ),
                    array(
                        'id'        => 'ajax_page',
                    ...
                    array(
                        ...
                        'type'      => 'multi_text',
                        'required'  => array('ajax_page', '=', 1),
                        'title'     => __('Excluded URLs', 'Vela'),
                        'subtitle'  => __('Excludes the specific links from AJAX Page Loader. This option allows you to exclude the page which contain some plugins that\'s conflict with the AJAX Loader. E.g. /shop/, /cart/, /checkout/, /gallery/, etc.', 'Vela'),
                        'add_text'  => __('Add New', 'Vela'),
                        'default'   => array(
                            '/shop/',
                            '/product/',
                            '/cart/',
            ...
            $this->sections['blog'] = array(
                ...
                'fields'    => array(
                    ...
                    array(
                        ...
                        'subtitle'  => __('Select blog page sidebar position.', 'Vela'),
                        'options'   => array(
            ...
            $this->sections['portfolio'] = array(
                ...
                'fields'    => array(
                    ...
                    array(
                        ...
                        'type'      => 'select',
                        'title'     => __('Lightbox Image Size', 'Vela'),
                        'subtitle'  => __('Select portfolio lightbox image size.', 'Vela'),
                        'options'   => array(
                            'blog-large' => 'Large (800 x 450)',
                            'blog-full' => 'Full (1024 x 768)',
                            'full' => 'Original',
                        ),
                        'default'   => 'full'
                    ),
                    ...
                    array(
                        ...
                        'title'     => __('Home Button', 'Vela'),
                        'subtitle'  => __('Display the "Home" button on portfolio single post.', 'Vela'),
                        'default'   => 0
                    ),
                    array(
                        ...
                        'title'     => __('Portfolio Home Page', 'Vela'),
                        'subtitle'  => __('The portfolio home page URL for the "Home" button on portfolio single post.', 'Vela'),
                        'default'   =>  get_site_url(get_current_blog_id(), '/porfolio') 
                    ),
                    array(
            ...
            <?php if ($screenshot) : ?>
                ...
                <div>
                    ...
                    <p><?php echo __('Tags', 'Vela'). ' '. esc_html( $this->theme->display('Tags') ); ?></p>
                    <?php
        ...
        public function setArguments() {
            ...
            $this->args = array(
                ...
                'page_title' =>  __('Theme Options', 'Vela'),
                'menu_type' => 'menu',
                'menu_title' => __('Theme Options', 'Vela'),
    ...
    global $wyde_theme_options;
    $wyde_theme_options = new Wyde_Theme_Options();
}