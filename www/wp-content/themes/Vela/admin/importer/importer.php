...
function wyde_importer() {
    ...
    if ( current_user_can( 'manage_options' ) && isset( $_GET['import_data'] ) && !empty($_GET['import_data']) ) {
        ...
        if ( class_exists( 'WP_Import' ) ) {
            ...
            try{
                ...
                if( $_GET['import_data'] == 'democontent'){
                    wyde_import_demo_content($demo);
                }
                wyde_set_woocommerce_pages();
...
function wyde_set_woocommerce_pages(){
...
function wyde_import_widgets($demo){
    ...
    try{
        ...
        if( $widgets_json && isset( $widgets_json['body'] ) ){
