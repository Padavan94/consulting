<?php
/*
Plugin Name: UberMenu 3 - The Ultimate WordPress Mega Menu | Shared By themes24x7.com
...
final class UberMenu {
	...
	private function setup_constants() {
		// Plugin version
		define( 'UBERMENU_VERSION', '3.2.0.2' );
		...
		//define( 'UBERMENU_UPDATES_URL' , 'http://updates.sevenspark.com/ubermenu' );
